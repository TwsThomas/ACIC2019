...
def run_main(id):
  ...
  if add_mask:
    ...
    np.savetxt(out_folder+dim+str(id)+"_h"+str(h)+"_d"+str(d)+"_mask"+"_propNA"+"{:3.2f}".format(perc_miss)+"_imp.csv", xhat_rescaled, delimiter=";")
    str_1 = dim+str(id)+"_h"+str(h)+"_d"+str(d)+"_mask"+"_propNA"+"{:3.2f}".format(perc_miss)+"_imp.csv"
  else:
    xhat_rescaled = xhat*np.std(data,0) + np.mean(data,0)
    np.savetxt(out_folder+dim+str(id)+"_h"+str(h)+"_d"+str(d)+"_propNA"+"{:3.2f}".format(perc_miss)+"_imp.csv", xhat_rescaled, delimiter=";")
    str_1 = dim+str(id)+"_h"+str(h)+"_d"+str(d)+"_propNA"+"{:3.2f}".format(perc_miss)+"_imp.csv"
#   !cp $str_1 $out_folder

  
  xmiss_rescaled = xmiss*np.std(data,0) + np.mean(data,0)
  np.savetxt(out_folder+dim+str(id)+"_propNA"+"{:3.2f}".format(perc_miss)+"_xmiss.csv", xmiss_rescaled, delimiter=";")
  str_2 = dim+str(id)+"_propNA"+"{:3.2f}".format(perc_miss)+"_xmiss.csv"
#   !cp $str_2 $out_folder

  if add_mask:
    np.savetxt(out_folder+dim+str(id)+"_h"+str(h)+"_d"+str(d)+"_mask"+"_propNA"+"{:3.2f}".format(perc_miss)+"_zhat.csv", zhat, delimiter=";")
    str_3 = dim+str(id)+"_h"+str(h)+"_d"+str(d)+"_mask"+"_propNA"+"{:3.2f}".format(perc_miss)+"_zhat.csv"
  else:
    np.savetxt(out_folder+dim+str(id)+"_h"+str(h)+"_d"+str(d)+"_propNA"+"{:3.2f}".format(perc_miss)+"_zhat.csv", zhat, delimiter=";")
    str_3 = dim+str(id)+"_h"+str(h)+"_d"+str(d)+"_propNA"+"{:3.2f}".format(perc_miss)+"_zhat.csv"
#   !cp $str_3 $out_folder
  ...
  #  if add_mask:
  #    np.savetxt(dim+str(id)+"_h"+str(h)+"_d"+str(d)+"_mask"+"_propNA"+"{:3.2f}".format(perc_miss)+"_imp_m"+str(i)+".csv", x_mul_imp_rescaled[i,:,:], delimiter=";")
  #    str_4 = dim+str(id)+"_h"+str(h)+"_d"+str(d)+"_mask"+"_propNA"+"{:3.2f}".format(perc_miss)+"_imp_m"+str(i)+".csv"
  #  else:
  #    np.savetxt(dim+str(id)+"_h"+str(h)+"_d"+str(d)+"_propNA"+"{:3.2f}".format(perc_miss)+"_imp_m"+str(i)+".csv", x_mul_imp_rescaled[i,:,:], delimiter=";")
  #    str_4 = dim+str(id)+"_h"+str(h)+"_d"+str(d)+"_propNA"+"{:3.2f}".format(perc_miss)+"_imp_m"+str(i)+".csv"
  #  !cp $str_4 $out_folder
    
  zhat_mul_rescaled = zhat_mul
  for i in range(num_samples_xmul):
    if add_mask:
      np.savetxt(out_folder+dim+str(id)+"_h"+str(h)+"_d"+str(d)+"_mask"+"_propNA"+"{:3.2f}".format(perc_miss)+"_zhat_m"+str(i)+".csv", zhat_mul_rescaled[i,:,:], delimiter=";")
      str_5 = dim+str(id)+"_h"+str(h)+"_d"+str(d)+"_mask"+"_propNA"+"{:3.2f}".format(perc_miss)+"_zhat_m"+str(i)+".csv"
    else:
      np.savetxt(out_folder+dim+str(id)+"_h"+str(h)+"_d"+str(d)+"_propNA"+"{:3.2f}".format(perc_miss)+"_zhat_m"+str(i)+".csv", zhat_mul_rescaled[i,:,:], delimiter=";")
      str_5 = dim+str(id)+"_h"+str(h)+"_d"+str(d)+"_propNA"+"{:3.2f}".format(perc_miss)+"_zhat_m"+str(i)+".csv"
    # !cp $str_5 $out_folder
